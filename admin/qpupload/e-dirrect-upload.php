...
swal("---File---", "File Upload", "success") }
    ...
    <body>
     <p id="profile1" style="color:red;margin-left:700px;margin-top:100px"><b>E-Dirrect Upload.....(include all project of a batch single file)</b></p><br>
    <center>
                          ...
                          if(isset($_POST["upload"]))
                            {
                                ...
                                $year=$_POST['year'];   
                                    ...
                                    echo $branch;
                                     $upload="insert into tbl_e-dirrect_upload(cource_id,branch_id,stream_id,semester,year,file) values('$cource','$branch','$stream','$semester','$year','$Filename')";
